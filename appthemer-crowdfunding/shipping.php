...
function atcf_shipping_address_fields() {
	...
	<fieldset id="atcf_shipping_address" class="atcf-shipping-address">
		<legend><?php __(_e( 'Shipping Address', 'atcf' ),'fundify'); ?></legend>

		<p id="atcf-edd-address-1-wrap">
			<label class="edd-label"><?php __(_e('Shipping Address', 'atcf'),'fundify'); ?></label>
			<span class="edd-description"><?php __(_e( 'Where should we send any physical goods?', 'atcf' ),'fundify'); ?></span>
			<input type="text" name="shipping_address" class="shipping-address edd-input required" placeholder="<?php __(_e('Address line 1', 'atcf'),'fundify'); ?>"/>
		</p>

		<p id="atcf-edd-address-2-wrap">
			<label class="edd-label"><?php __(_e('Shipping Address Line 2', 'atcf'),'fundify'); ?></label>
			<input type="text" name="shipping_address_2" class="shipping-address-2 edd-input required" placeholder="<?php __(_e('Address line 2', 'atcf'),'fundify'); ?>"/>
		</p>

		<p id="atcf-edd-address-city">
			<label class="edd-label"><?php __(_e('Shipping City', 'atcf'),'fundify'); ?></label>
			<input type="text" name="shipping_city" class="shipping-city edd-input required" placeholder="<?php __(_e('City', 'atcf'),'fundify'); ?>"/>
		</p>

		<p>
			<label class="edd-label"><?php __(_e('Shipping Country', 'atcf'),'fundify'); ?></label>
		...
		<p>
			<label class="edd-label"><?php __(_e('Shipping State / Province', 'atcf'),'fundify'); ?></label>
			<input type="text" size="6" name="shipping_state_other" id="shipping_state_other" class="shipping-state edd-input" placeholder="<?php __(_e('State / Province', 'atcf'),'fundify'); ?>" style="display:none;"/>
		...
		<p>
			<label class="edd-label"><?php __(_e('Shipping Zip / Postal Code', 'atcf'),'fundify'); ?></label>
			<input type="text" size="4" name="shipping_zip" class="shipping-zip edd-input required" placeholder="<?php __(_e('Zip / Postal code', 'atcf'),'fundify'); ?>"/>
		</p>
