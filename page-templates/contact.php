...
get_header(); ?>
	...
	<div id="title-image">
		...
		<h1><?php 
			...
			$lines = explode( "\n", $string );
		?>
		<span><?php echo apply_filters('fundify', implode( '</span><br /><span>', $lines )); ?></span></h1>
	</div>
	<div id="content">
		<div class="container">
			<div class="contacts">
				<div class="address">
					<div class="left contact-address"><?php echo apply_filters('fundify', wpautop( fundify_theme_mod( 'contact_address' ) ) ); ?></div>
					<div class="left"><a href="mailto:<?php echo get_option( 'admin_email' ); ?>"><?php echo get_option( 'admin_email' ); ?></a></div>
				</div>
				<h2 class="contact-subtitle"><?php echo apply_filters('fundify', fundify_theme_mod( 'contact_subtitle' )); ?></h2>
				<div class="div-c"></div>
				<div id="respond">
